        ...
        var Player = MediaPlayer.extend({
            ...
            playFrom: function (seconds) {
                ...
                switch (this.getState()) {
                    ...
                    case MediaPlayer.STATE.COMPLETE:
                        ...
                        this._playerPlugin.Execute("StartPlayback");        // <TODO> set seeking to some how
                        this.logger.info('1) called this.playerPlugin.Execute("StartPlayback");');
                        this._toBuffering();
                        break;
            ...
            beginPlayback: function() {
                ...
                switch (this.getState()) {
                    case MediaPlayer.STATE.STOPPED:
                        ...
                        this.logger.info('2) called this.playerPlugin.Execute("StartPlayback",0)');
                        break;
            ...
            beginPlaybackFrom: function(seconds) {
                ...
                switch (this.getState()) {
                    case MediaPlayer.STATE.STOPPED:
                        ...
                        this.logger.info('3) called this.playerPlugin.Execute("StartPlayback") with success=' + success);
                        this._toBuffering();
                        break;
            ...
            */
            ...
            _jump: function (offsetSeconds) {
                this.logger.info('_jump(): ' + offsetSeconds);

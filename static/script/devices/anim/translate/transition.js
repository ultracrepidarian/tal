...
define(
    'antie/devices/anim/translate/transition',
    [
        'antie/class',
                ...
                _doTransition: function() {
                    ...
                    for(i = 0; i !== properties.length; i += 1) {
                        ...
                        if (prop === 'top' || prop === 'left') {
                            if (prop === 'top') {
                                destination = 'translateY(' + destination + ')';
                            } else {
                                destination = 'translateX(' + destination + ')';
                            }
                            this._transEl.setStylePropertyValue('transform', destination);
                            this._transEl.setStylePropertyValue('-webkit-transform', destination);
                            this._transEl.setStylePropertyValue('-o-transform', destination);
                            this._transEl.setStylePropertyValue('-moz-transform', destination);
                        } else {
